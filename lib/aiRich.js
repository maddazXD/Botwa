 ...
 * lib/aiRich.js
 *
 * PORTING dari library "NIXCODE - Advanced WhatsApp Interactive Message
 * Builder" (dibuat oleh Nixel, WA: wa.me/6285188349341) yang dipakai project
 * XAYNC_MD, dari messagebuilder.js (ES Module) ke CommonJS supaya bisa
 * dipakai di project ini.
 *
 * Sesuai syarat lisensi library aslinya, watermark/atribusi berikut WAJIB
 * dipertahankan ("Do not remove this watermark"):
 *
 ...
 *
 * CATATAN PORTING (bukan dari file asli):
 * - Hanya class AIRich (+ dependency wajibnya: extractIE, waitAllPromises,
 *   error classes, Toolkit, BaseBuilder) yang diporting. Class Button,
 *   ButtonV2, dan Carousel dari file asli SENGAJA TIDAK diikutkan karena
 *   tidak dipakai oleh fitur game yang diporting (addSection/build/send
 *   dari AIRich saja yang dibutuhkan) — mengurangi ~600 baris kode yang
 *   tidak terpakai.
 * - import ES Module diganti require() CommonJS. Tidak ada perubahan pada
 *   logic/behavior di dalam method manapun.
 * - Fungsi generateWAMessageFromContent, prepareWAMessageMedia,
 *   generateMessageIDV2 SUDAH DIVERIFIKASI ada & bernama sama persis di
 *   fork @itsliaaa/baileys yang dipakai project ini (lib/Utils/messages.js
 *   fork tsb), jadi require('baileys') di bawah diganti ke fork tsb.
 */
...
const { generateWAMessageFromContent, prepareWAMessageMedia, generateMessageIDV2 } = require('@itsliaaa/baileys');
...
module.exports = { VERSION, AIRich, Toolkit, AIRichError, ItemNotFoundError, DuplicateIdError, InvalidTargetError, ContentValidationError };
